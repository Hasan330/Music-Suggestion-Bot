...
module.exports = {
    run: function(event, user) {
        ...
        switch (messageCriteria) {
            case "greetings":
                staticReplies.greetings(userObj)
                break;
            case "mood":
            ...
            case "name":
                ...
                break;
            case "dislike2":
                updateMusicTaste.run(user, messageCriteria, false)
                break;
            case "dislike":
                updateMusicTaste.run(user, messageCriteria, false)
                break;
            case "nuetral":
                ...
                break;
            case "like1":
                updateMusicTaste.run(user, messageCriteria, true)
                break;
            case "like2":
                updateMusicTaste.run(user, messageCriteria, true)
                break;
            default:
                suggestSong.run(messageCriteria, user)
        }
    }
}
