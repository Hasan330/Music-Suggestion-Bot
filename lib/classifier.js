...
function train() {
    ...
    classifier.addDocument("I am mahmoud", "userName")
    classifier.addDocument("I am hasan", "userName")
    classifier.addDocument("I am ellen", "userName")
    classifier.addDocument("I am walaa", "userName")
    ...
    classifier.addDocument("i don't don't don't don't do not do not like it", "dislike")
    classifier.addDocument("this is some bad music", "dislike")
    classifier.addDocument("saying eww or ew or ewww means you don't like it", "dislike")
