...
function trainBot() {
    ...
    classifier.addDocument("terrible ugly disgusting", "dislike2")
    classifier.addDocument("bad", "dislike1")
    classifier.addDocument("bad not ", "dislike1")
    classifier.addDocument("ok", "nuetral")
    classifier.addDocument("nuetral thing", "nuetral")
    classifier.addDocument("good", "like1")
    classifier.addDocument("good nice", "like1")
    classifier.addDocument("beautiful", "like2")
    classifier.addDocument("awesome beautiful perfect lovely", "like2")
    classifier.addDocument("perfect", "like2")
